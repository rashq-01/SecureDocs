      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        <div className="card">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-text-secondary uppercase tracking-wider">Pending Review</p>
        ...
        <div className="card">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-text-secondary uppercase tracking-wider">Approved</p>
        ...
        <div className="card">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-text-secondary uppercase tracking-wider">Rejected</p>
